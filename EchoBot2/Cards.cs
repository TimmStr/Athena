...
namespace Microsoft.BotBuilderSamples
{
    public static class Cards
    {
        ...
        public static HeroCard GetHeroCard(string customerType)
        {
            var heroCard = new HeroCard
            {
                ...
                Buttons = new List<CardAction> { new CardAction(ActionTypes.OpenUrl, "Support", value: "https://www.google.com/search?q=unsere+nicht+vorhandene+webseite"), 
                    new CardAction(ActionTypes.PostBack, "Informations", "xyz675tz89"),
                    new CardAction(ActionTypes.ImBack, "Back", value: "nichts")},
            };
            return heroCard;
        }
