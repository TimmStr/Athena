...
namespace Microsoft.BotBuilderSamples
{
    public class MainDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> ChoiceCardStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                Prompt = MessageFactory.Text("Select your customerstatus"),
                RetryPrompt = MessageFactory.Text("That was not a valid choice, please select a card or number from 1 to 3."),
                Choices = GetChoices(),
            };
        ...
        private async Task<DialogTurnResult> ShowCardStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            switch (((FoundChoice)stepContext.Result).Value)
            {
                    ...
                    // Display an Adaptive Card
                        ...
                        reply.Attachments.Add(Cards.GetHeroCard(customerType).ToAttachment());
                        break;
        ...
        private IList<Choice> GetChoices()
        {
            ...
            {
                new Choice() { Value = "Private customer", Synonyms = new List<string>() { "hero" } },
                new Choice() { Value = "Business customer", Synonyms = new List<string>() { "hero" } },
                new Choice() { Value = "QnA", Synonyms = new List<string>() { "hero" } },
                /*
